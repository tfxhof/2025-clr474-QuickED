<script>
  ...
  import { generateURL} from '$lib/URLfunctions.js';
  import Toastify from 'toastify-js';
  import 'toastify-js/src/toastify.css';

  //Final and base text are passed
  export let baseText = "";
  export let finalText = "";
  export let editorMode = true;
  ...
  let state = (baseText || finalText) ? States.ShowBoth : States.Init;
  let text = ""; 
  let warningMessage = "";
  ...
  navigator.clipboard.writeText(finalText)
    .then(() => {
      Toastify({
        text: "Final text copied to clipboard!",
        duration: 3000,
        gravity: "top", 
        position: "center",
